...
void Theme::loadTheme() {
    ...
    themes[LIGHT_THEME_ID].NODE_BACKGROUND_DISABLED = LIGHTGRAY;
    ...
    themes[LIGHT_THEME_ID].NODE_FOREGROUND_DISABLED = DARKGRAY;
    ...
    themes[LIGHT_THEME_ID].NODE_BORDER_DISABLED = DARKGRAY;
    ...
    themes[DARK_THEME_ID].NODE_BACKGROUND_DISABLED = Color{242, 231, 254, 255};
    ...
    themes[DARK_THEME_ID].NODE_FOREGROUND_DISABLED = Color{152, 94, 255, 255};
    ...
    themes[DARK_THEME_ID].NODE_BORDER_DISABLED = Color{187, 134, 252, 255};
