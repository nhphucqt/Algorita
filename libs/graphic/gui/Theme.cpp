...
void Theme::loadTheme() {
    ...
    themes[LIGHT_THEME_ID].TEXT_EDITOR_BACKGROUND = Color{201, 200, 200, 255};
    themes[LIGHT_THEME_ID].TEXT_EDITOR_FOREGROUND = BLACK;
    themes[LIGHT_THEME_ID].TEXT_EDITOR_LINE_NUMBER_BACKGROUND = Color{168, 167, 167, 255};
    themes[LIGHT_THEME_ID].TEXT_EDITOR_LINE_NUMBER_FOREGROUND = BLACK;
    ...
    themes[DARK_THEME_ID].TEXT_EDITOR_BACKGROUND = Color{43, 43, 59, 255};
    themes[DARK_THEME_ID].TEXT_EDITOR_FOREGROUND = WHITE;
    themes[DARK_THEME_ID].TEXT_EDITOR_LINE_NUMBER_BACKGROUND = Color{30, 30, 40, 255};
    themes[DARK_THEME_ID].TEXT_EDITOR_LINE_NUMBER_FOREGROUND = LIGHTGRAY;
