...
void Theme::loadTheme() {
    ...
    // themes[LIGHT_THEME_ID].NODE_BACKGROUND_FOCUS_NEAR_ITER = Color{255,215,181,255};
    ...
    themes[LIGHT_THEME_ID].NODE_FOREGROUND_FOCUS_ITER = ORANGE;
    ...
    themes[DARK_THEME_ID].NODE_FOREGROUND_FOCUS_ITER = Color{255, 148, 0, 255};
