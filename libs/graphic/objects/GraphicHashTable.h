...
public:
    ...
    ExitStatus initialize(int initSize, std::string strVals, ListOfOperationsGroups* ALOG); // Initialize with given values
    ...
    ExitStatus pop(int val, ListOfOperationsGroups* ALOG);
