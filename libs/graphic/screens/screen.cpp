...
void Screen::ScreenClass::load() {
    ...
    screenInit[CIRCULAR_LINKED_LIST] = std::bind(&ScreenCircularLinkedList::init, &screenCLL);
    ...
    screenDraw[CIRCULAR_LINKED_LIST] = std::bind(&ScreenCircularLinkedList::draw, &screenCLL);
    ...
    screenDest[CIRCULAR_LINKED_LIST] = std::bind(&ScreenCircularLinkedList::destroy, &screenCLL);
