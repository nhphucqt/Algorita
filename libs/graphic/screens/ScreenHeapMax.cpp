#include "ScreenHeapMax.h"

Screen::ScreenHeapMax::ScreenHeapMax(): obj(true) {}
Screen::ScreenHeapMax::~ScreenHeapMax() {}

void Screen::ScreenHeapMax::load() { // Ensure that obj has to be destroy before (prevent MEMORY LEAKING)
...
void Screen::ScreenHeapMax::destroy() {
    ALOG.destroy();
    obj.destroy();
}